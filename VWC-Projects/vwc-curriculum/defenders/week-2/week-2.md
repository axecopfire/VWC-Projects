...
+ `http` - the protocol
+ `vetswhocode.io` - the domain
+ `/vwc.gif` - the resource
...
Our client makes a request to server. In this case. The server then responds with all the code associated with that resource `<!doctype html> .....</html>`, including all images, CSS files, JavaScript files, videos, music, etc. 
...
It gets a little bit more complex with a webapp. The client makes a request, the server runs application code (think of this as your Node.js code), and returns a dynamically generated response. 

## Read this
1. [How the Web Works in Five Minutes](https://www.youtube.com/watch?v=7_LPdttKXPc)
1. [Submarine Cable Map](http://submarine-cable-map-2016.telegeography.com/)
1. [Map Of The Internet](https://qz.com/se/map-of-the-internet/)
1. [Mozilla How The web works](https://developer.mozilla.org/en-US/docs/Learn/Getting_started_with_the_web/How_the_Web_works)

## Homework
1. Write a post about how the internet works. Extra points for sense of humor.
